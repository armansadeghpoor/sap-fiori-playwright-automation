...
test("test", async ({ page }) => {
  ...
  await page.getByText("انتساب نقش-اولین استفاده از نقش").click();
  ...
  await page.getByText("انتساب نقش-زمان مقداردهی-اولین استفاده از نقش").click();
  await page.getByRole("cell", { name: "" }).first().click();
  await page.getByRole("textbox").click();
  await page.getByRole("textbox").fill("پاسخ009");
  await page.getByRole("button", { name: "تایید" }).click();
  await page.locator("#fd-avatar-0 fd-icon").click();
  await page.getByRole("menuitem", { name: "خروج" }).click();
  await page.getByRole("button", { name: "بله" }).click();
  ...
  await page.getByText("انتساب نقش-زمان مقداردهی-اولین استفاده از نقش").click();
  await page
    .getByRole("row", { name: "‫تیکت009‬ ‫" })
    .getByRole("button")
    .click();
  await page.getByRole("button", { name: "Select Options" }).click();
  await page.getByText("در جریان").click();
  await page.getByRole("button", { name: "تایید" }).click();
  await page.locator("#fd-avatar-0 fd-icon").click();
  await page.getByRole("menuitem", { name: "خروج" }).click();
  await page.getByRole("button", { name: "بله" }).click();
